...
public class YatzyTest {
    ...
    @Test
    public void shouldReturnFifteenWhenChanceScoresIsFifteen(){
        //GIVEN
    ...
    @Test
    public void shouldReturnSixteenWhenChanceScoresIsSixteen() {
        //GIVEN
    ...
    public void two_Pair() {
        assertEquals(16, Yatzy.twoPair(new DiceRolls(3,3,5,4,5)));
        assertEquals(0, Yatzy.twoPair(null));
        assertEquals(16, Yatzy.twoPair(new DiceRolls(3,3,5,5,5)));
        assertEquals(14, Yatzy.twoPair(new DiceRolls(2,2,5,5,5)));
        assertEquals(12, Yatzy.twoPair(new DiceRolls(1,1,5,5,5)));
    }
